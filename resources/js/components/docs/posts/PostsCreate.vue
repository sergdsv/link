                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" v-model="post.need_an_answer" type="radio" name="need_an_answer" id="need_an_answer1" :value="true" checked>
                            <label class="form-check-label" for="need_an_answer1">
                                Не требует
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" v-model="post.need_an_answer" type="radio" name="need_an_answer" id="need_an_answer2" :value="false">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="signature_on_receipt" id="signature_on_receipt1" :value="true" v-model="post.signature_on_receipt" checked>
                            <label class="form-check-label" for="signature_on_receipt1">
                                Да
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="signature_on_receipt" id="signature_on_receipt2" :value="false" v-model="post.signature_on_receipt">
...
<script>
    ...
    export default {
        ...
        mounted() {
            var app = this;
            axios.get('/api/doc/create')
                .then(function (resp) {
                    app.organizations = resp.data.organizations
        ...
        methods: {
            saveForm() {
                ...
                for (var i=0; i < this.arr.length; i++){
                    formData.append("image[]", this.arr[i]);
